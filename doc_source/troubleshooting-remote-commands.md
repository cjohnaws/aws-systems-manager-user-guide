...
+ Verify that you have selected the relevant Command document from the list. For example, if you select a Windows only document, you will not see the Linux instances listed.
